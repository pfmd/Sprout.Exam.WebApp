          ...
          <div className="form-row">
            ...
            {this.state.typeId === 1 ?
              <div className='form-group col-md-6'>
                ...
                <input type='number' pattern="[0-9]*" min='0' step='.01' className='form-control' id='inputAbsentDays4' onChange={this.handleChange.bind(this)} value={this.state.absentDays} name="absentDays" placeholder='Absent Days' />
              </div> :
              <div className='form-group col-md-6'>
